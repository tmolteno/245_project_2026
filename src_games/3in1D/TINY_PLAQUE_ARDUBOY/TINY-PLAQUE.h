...
return blitzSprite(MainSprite_TPLAQUE.X(),MainSprite_TPLAQUE.Y(),xPASS,yPASS,((MainSprite_TPLAQUE.DIRECTION_Y()==-1)?0:1)+(GD.TUBE_FUEL*2),tube_TPLAQUE);
}
...
BYTE_t=BYTE_t|blitzSprite(M_Spr[t].X(),M_Spr[t].Y(),xPASS,yPASS,GD.Food_Type,FOOD_TPLAQUE);
SUITE:;
}
return BYTE_t;
}
...
if ((weapon.ACTIVE()==1)&&(xPASS==MainSprite_TPLAQUE.X()+3)) {
  RECUP_WEAPON=blitzSprite(xPASS,weapon.Y(),xPASS,yPASS,0,BALISTIC_TPLAQUE);
  }else{
    RECUP_WEAPON=0x00;
    }
...
switch (T_FLIP){
 case 0: arduboy.SPItransfer(Recupe_TPLAQUE(x,y)|recupe_SCORES_TPLAQUE(x,y)|Recupe_ExtraTeeth_TPLAQUE(x,y));break;
 case 1: arduboy.SPItransfer(Recupe_DCOUNT_TPLAQUE(x,y)|recupe_SCORES_TPLAQUE(x,y)|Recupe_ExtraTeeth_TPLAQUE(x,y));break;
 case 2: arduboy.SPItransfer(Recupe_TPLAQUE(x,y)|recupe_SCORES_TPLAQUE(x,y)|Recupe_ExtraTeeth_TPLAQUE(x,y));break;
 case 3: arduboy.SPItransfer(recupe_SCORES_TPLAQUE(x,y)|INTRO_TPLAQUE(x,y)|BACK_TPLAQUE(x,y));break;
 default:break;
}}
}}
...
uint8_t INTRO_TPLAQUE(uint8_t xPASS,uint8_t yPASS){
uint8_t BYTE_=0x00;
if (BLINK_START_TPLAQUE>11) {BYTE_=blitzSprite(38,26,xPASS,yPASS,0,START_TPLAQUE);}
return BYTE_;}
...
if (yPASS>0) {return 0;}
return 
(SPEED_BLITZ(12,0,xPASS,yPASS,M10000_TPLAQUE,police_TPLAQUE)|
 SPEED_BLITZ(16,0,xPASS,yPASS,M1000_TPLAQUE,police_TPLAQUE)|
 SPEED_BLITZ(20,0,xPASS,yPASS,M100_TPLAQUE,police_TPLAQUE)|
 SPEED_BLITZ(24,0,xPASS,yPASS,M10_TPLAQUE,police_TPLAQUE)|
 SPEED_BLITZ(28,0,xPASS,yPASS,M1_TPLAQUE,police_TPLAQUE)|
 SPEED_BLITZ(32,0,xPASS,yPASS,0,police_TPLAQUE));
}
