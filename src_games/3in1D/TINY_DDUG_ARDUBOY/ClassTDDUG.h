...
switch(dir_){
  case(0):if (RecupeDecalageY(X()-20)!=0) {PUT_DIRECTION_Y(RND_TDDUG());}break;  
  case(1):if (RecupeDecalageY(Y())!=0) {PUT_DIRECTION_X(RND_TDDUG());}break;  
}}
...
if (RecupeDecalageY(Y())==0) {MDROITE();
}else{
switch(DIRECTION_Y()){
  case  (1):MBAS(); break;
  case (-1):MHAUT();break;
...
if (RecupeDecalageY(Y())==0) {MGAUCHE();
}else{
switch(DIRECTION_Y()){
  case  (1):MBAS(); break;
  case (-1):MHAUT();break;
...
if (RecupeDecalageY(X()-20)==0) {MHAUT();
}else{
switch(DIRECTION_X()){
...
if (RecupeDecalageY(X()-20)==0) {MBAS(); 
}else{
switch(DIRECTION_X()){
  case  (1):MDROITE(); break;
  case (-1):MGAUCHE();break;
