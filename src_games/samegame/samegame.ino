...
#define callInitFunc(idx)   ((void (*)(void)) moduleTable[idx].initFunc)()
#define callUpdateFunc(idx) ((MODE_T (*)(void)) moduleTable[idx].updateFunc)()
#define callDrawFunc(idx)   ((void (*)(void)) moduleTable[idx].drawFunc)()
...
PROGMEM static const MODULE_FUNCS moduleTable[] = {
    ...
    { initEditor,   updateEditor,   drawEditor },
};
