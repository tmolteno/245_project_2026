...
uint8_t AD4=0,AD3=0,AD2=0,AD1=0,AD0=0;
...
void Recupe_HighScore(void){
uint16_t Score1=HighScore(AD3,AD2,AD1,AD0);
...
if ((arduboy.pressed(LEFT_BUTTON))&&(sprite[0].Joypad_Key==0)) {SEED_RND();LimitCheck(0,4,&sprite[0]);}
if ((arduboy.pressed(RIGHT_BUTTON))&&(sprite[0].Joypad_Key==0)) {LimitCheck(0,2,&sprite[0]);}
if ((arduboy.pressed(DOWN_BUTTON))&&(sprite[0].Joypad_Key==0)) {LimitCheck(0,3,&sprite[0]);}
if ((arduboy.pressed(UP_BUTTON))&&(sprite[0].Joypad_Key==0)) {SEED_RND();LimitCheck(0,1,&sprite[0]);}
...
if ((xPASS>=99)&&(xPASS<=102)) {return pgm_read_byte(&police[(xPASS-99)+(AD4*4)]);}
if ((xPASS>=103)&&(xPASS<=106)) {return pgm_read_byte(&police[(xPASS-103)+(AD3*4)]);}
if ((xPASS>=107)&&(xPASS<=110)) {return pgm_read_byte(&police[(xPASS-107)+(AD2*4)]);}
if ((xPASS>=111)&&(xPASS<=114)) {return pgm_read_byte(&police[(xPASS-111)+(AD1*4)]);}
if ((xPASS>=115)&&(xPASS<=118)) {return pgm_read_byte(&police[(xPASS-115)+(AD0*4)]);}
return 0x00;
};
...
for (y = 0; y < 8; y++){ 
for (x = 0; x <128; x++){
arduboy.SPItransfer(Recupe(x,y,DATA));}
}}
