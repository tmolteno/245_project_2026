...
#define PIN_SPEAKER_1 PIN_BEEP  /**< The pin number of the first lead of the speaker */
#define PIN_SPEAKER_2 PIN_BEEP /**< The pin number of the second lead of the speaker */
